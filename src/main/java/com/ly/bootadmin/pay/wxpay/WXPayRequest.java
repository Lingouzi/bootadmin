package com.ly.bootadmin.pay.wxpay;
...
import static com.ly.bootadmin.pay.wxpay.WXPayConstants.USER_AGENT;
...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception, ConnectTimeoutException {
